...
public class Buffer {
    ...
    public int Buffer(int maxSize, int minSize, int requestSize, Buffer parent){
    ...
    private int checkRequest(int requestSize) {
    ...
    private int splitBuffer(int requestSize) {
